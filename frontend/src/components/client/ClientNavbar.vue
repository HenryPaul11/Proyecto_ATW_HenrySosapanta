    ...
    <div class="max-w-[1200px] mx-auto px-4 sm:px-8 h-16 flex items-center justify-between gap-4">
      ...
      <div class="hidden md:flex items-center gap-3">
        <div class="flex items-center gap-2 bg-blue-50 rounded-xl px-3 py-1.5">
          <div class="w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs font-bold">{{ inicial }}</div>
      ...
      <div class="flex items-center gap-2 md:hidden">
        ...
        <div class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs font-bold">{{ inicial }}</div>
